...
export function ContactSection({
  ...
  return (
    <div className="text-zinc-100">
      <div
        className={
          embedded
            ...
            : "shrink-0 border-b border-white/10 px-1 pb-4 pt-1 sm:px-2"
        }
      >
      ...
      {status === "success" ? (
        <div className="px-1 py-8 text-center sm:px-2">
        ...
        <div className="grid gap-0 lg:grid-cols-2 lg:gap-0">
          <aside className="order-2 border-t border-white/5 px-1 py-6 sm:px-2 sm:py-8 lg:order-1 lg:border-t-0">
          ...
          <div className="order-1 px-1 py-6 sm:px-2 sm:py-8 lg:order-2">
            <form
